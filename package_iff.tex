...
%\setlength{\intextsep}{14pt plus 4pt minus 2pt}% lead to text overlap
%\setlength{\belowcaptionskip}{-\baselineskip}\addtolength{\belowcaptionskip}{2.5ex}
...
\bibliography{mypublist.bib,\bibpath/ECD.bib,\bibpath/tungsten_newandgood.bib,\bibpath/ACSnano.bib,%
