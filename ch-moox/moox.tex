...
\begin{figure}[htb]
\centering
\includegraphics[width=0.4\textwidth]{Na2MoO4_Phase}
...
The various growth morphologies found using alkaline metal based materials as catalysts demonstrate the proposed VLS mechanism and transverse mode is a general phenomenon, and broad engineering space could be explored to control the dimension of \ce{MoO3}. 
