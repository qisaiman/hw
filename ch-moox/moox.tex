...
\chapter{Vapor-Solid-Solid Growth of MoO$_3$}
...
\caption[Phase diagram of \ce{Na2MoO4} and \ce{MoO3}]{Phase diagram of \ce{Na2MoO4} and \ce{MoO3} reproduced from Ref.~\cite{Hoermann1929}}
\label{fig:ch4pd}
\end{figure}
...
\caption{Optimized \ce{MoO3} nanoplates growth on glass.}
\label{fig:ch4glass}
\end{figure}
