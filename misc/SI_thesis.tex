...
\section{A LONG SECTION TITLE FOR TOC CONTENT LINE WRAPPING TEST TEST TEST A LONG SECTION TITLE FOR TOC CONTENT LINE WRAPPING TEST TEST TEST}
...
\ce{WO3}, \ce{WP3.H2O}\cite{Daniel1987}
