...
solid-solid wetting for \ce{MoO3}, \ce{WO3}, and \ce{V2O5} spreading.\cite{Leyrer1988} Experimental evidence supports the oxyhydroxide are intermediates in the surface chemical transformation of these oxides into surface polyoxoanions in the presence of \ce{H2O} vapor. The spreading occurs independent of polymolybdate formation and in the absence of \ce{H2O} vapor; the solid-solid wetting driven by a gradient of the surface free energy. Gas form transport is discarded as the dominanting mechanism. 

\ce{MoO3} wet \ce{Al2O3} and \ce{TiO2} but not \ce{SiO2}; \ce{MoO3} reacts with \ce{Al2O3} in solid state to form \ce{Al2(MoO4)3} and with \ce{TiO2} to form \ce{Ti(MoO4)2}, yet reaction with \ce{SiO2} not reported. 
...
Basic operations and several growth recipes using the home-built cvd system are included in Appendix.
...
\ce{WO3} \cite{Zhang2015}
VBM at 3V versus NHE, strongly oxidative to drive oxygen evolution. 


\ce{WO3} NW on FTO.\cite{Kalanur2013} hole diffusion length of 150 nm, without in-depth discussion.  improve IPCE (incident photon-to-electron conversion efficiency) by exploiting nanostructured \ce{WO3}, 1D good for the light absorption and charge separation. not grow on ITO, Si, and glass, only on FTO. ref24 

PEC by \ce{WO3} film, 6.7 $\mu$m diffusion length, n-type semi (n-SC), semi-electrolyte interface, photo-excited charge carriers were separated by the electric field in the depletion region of SC.\cite{Wang2000} UV-Vis in ref 13, and photoelectrochemistry in ref 15. Look for the excited-state lifetime. 

\[
\cee{4h\nu + n-SC + 2H2O \rightarrow O2 + 2H2 + n-SC}
\]
below the onset potential, all photogenerated charge carriers recombine or lost in the interfacial reactions. At equilibrium in the dark, the Fermi level of SC is the same as the electrode potential of the solution. When overpotential is less than 1500 mV (why 1500, what to do with 700 mV for Si), VB of \ce{WO3} is not reached. With band gap illumination, excited electron and hole generated. At open circuit condition, Fermi level of SC shift up, or to a more negative potential. This potential shift is the driving force of electrons in two-electrode system, such as solar cell, and can be described by 
\[
...
electron transport, \ce{Fe2O3} with suitable band gap of 2.1 eV, but low charge carrier mobility and short diffusion length (20nm), unpaired spin are highly localized due to the radius of 3d orbitals for the first-row transitiona metals.\cite{Yourey2011} Tungsten oxide is diamagnetic, hole mobility of 10 \si{cm^2V^{-1}s^{-1}}, \cite{Butler1977}. \ce{WO3} only stable under acidic conditions; at pH $>5$, it dissolves. Spectra were recorded in reflectance mode. Impedance data show the valance band edge of \ce{CuWO4} is raised by 0.5 V compared to that in \ce{WO3}, and the flat band potential of \ce{CuWO4} matches that of \ce{WO3}, being +0.4 V vs NHE. 


\ce{WO3} charge carrier dynamics by transient absorption spectroscopy, 95\% recombination within 10 $\mu$s, the requirement of photoholes with a lifetime on ms to seconds time scale for water oxidation on \ce{WO3}.   \cite{Pesci2011}

\ce{NaxWO3} electronic structure by UPS. \cite{Hochst1982}

\ce{WO3} ECD and pseudocapacitance due to redox reaction between \ce{W6+} and \ce{W5+}.\cite{Yang2014} galvanostatic, 

Schottky barrier mode for \ce{WO3} electrolyte interface.\cite{Butler1977} Field-induced shift of band gap observed, on the order of 300 meV; The CE is made large enough (so no \ce{H2} evolution overpotential exists) not to limit the kinetics of oxygen evolution at WE; It was found that the hole diffusion length is about one tenth of the depletion layer width; and optical absorption depth is comparable to the depletion layer thickness. 
...
\ce{WS2} exciton binding energy 0.71 eV , exciton A of 2 eV and B of 2.4 eV from direct band gap at K valley of the BZ. \cite{Zhu2014a}
...
Substrate effects on Raman and PL of TMDC.\cite{Buscema2014} \ce{MoS2} PL on Au is not quenched for 1L. 
...
1T \ce{WS2} hydrogen evolution.\cite{Voiry2013a}

\ce{WS2} nanotube has been studied because of the strong lubricant;  
The sulfurization of tungsten oxide, proved as a high yield approach, has been studied throughly for preparing \ce{WS2} nanotubes. Few wall \ce{WS2} can be used to obtain nanoribbon. The properties of \ce{WS2} nanotube can help to understand the confinement in \ce{WS2} nanoribbon.

The growth design, emphasizing the absence of \ce{H2}; 

\ce{WS2} NIR photocatalysis.\cite{Sang2014}


\ce{WS2} hydrogen evolution can be achieved by using large potential and expensive Pt-based catalysts. Finding inexpensive replacement would enable large scale HER applications.\cite{Voiry2013a} \ce{WS2} nanosheets exfoliated by chemical reaction, and 1T (octahedral) phase is associated with the enhanced electrocatalytic activity. Energy barrier from 1T to 2H transformation is calculated to be 0.95 eV, explained why 1T is stable in ambient environment. 
...
Charge separation and the geometrical influence. catalytic activity is associated to the oxygen vacancy, substoichiometry, or plasmon. \ce{WO3} nanosheet carrier density derived from UV-Vis using Drude model $\omega_p = \sqrt{\frac{N_e e^2}{\epsilon_0 m_e}}$ and from Mott-Schottky measurement. PL data of \ce{WO3-x} obtained using 360 nm excitation.\cite{Yan2015}

\ce{MoS2} FET.\cite{Li2015}

(Good writing) Hot carriers generation and collection device bansed on TCO.\cite{Gong2014a} Metal-SC contact as Schottky photodetector, where hot electron generated in metal and was injected into SC. ITO-\ce{Al2O3}-Au, where e in Au traverse 5 nm \ce{Al2O3}. 
...
\ce{WS2} for cancer cell thermo-therapy. \cite{Cheng2014}


\ce{Na_{0.33}WO3} by W coating on glass and annealing.\cite{Azimirad2009a} the amount of Na ions matter in regarding to the final composition.\cite{Mann2007} 
...
In ambient environment, \ce{MoS2} oxidized into oxides when $T > 350$ \si{\degreeCelsius}.\cite{Su2014a} 
...
Raman and PL of \ce{MoS2} on dielectric and conducting substrates. 514 nm, 20 $\mu$m aperture, 0.5 \si{cm^{-1}} resolution, 0.25 mW power, and 10 s integration time. \cite{Buscema2014} The substrate-dependent interferometric stacking does not perturb the peak emission wavelength but strongly influences the emission intensity. \ce{SiO2} charge impurity induced doping, leading to enhanced electron density, is proposed to explain the softening of A1g mode on \ce{SiO2}. 

metallic sub affect PL by additional non-radiative path for exciton recombination, such as charge transfer and dipole-dipole interaction. But on Au \ce{MoS2} PL is enhanced compared to that on \ce{SiO2} after normalization. Charged exciton results in PL in redshifted wavelength. 
...
Tungsten bronze: \ce{A_xWO3}, or \ce{A_xW_{1-x}^{6+}W_x^{5+}O3}, 
...
\ce{MoO3} pseudo-capacitor  \cite{Brezesinski2010}
