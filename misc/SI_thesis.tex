...
803(vs)     & $A_g$       &           & $R_c$    \\
\midrule
230(m)   & $B_{3g}$     & $\delta$ & \ce{O=Mo=O}  \ce{WO3.H2O} \\
380(w)   & $B_{1g}$     & $\delta$ & \ce{O-Mo-O}  & scissor  \\
