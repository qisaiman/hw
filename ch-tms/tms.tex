...
\caption[X-ray diffraction spectra before and after sulfurization]{X-ray diffraction spectra before and after sulfurization. The reference spectra for $c$-W, 2H-\ce{WS2} and $m$-\ce{WO3} are included with some major peaks labeled.}
\label{fig:ch5ws2xrd}
\end{figure}
...
\caption{HRTEM imaging on one core-shell nanowire showing consumed core.}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.6\textwidth]{ws2_sio2_all}
