...
\begin{figure}[htb]
\centering
\includegraphics[width=0.7\textwidth]{ws2_tube1}
...
\begin{table}[htb]
\centering
\caption{TMDC few layer growth methods summary}\label{tab:tmsgrowth}
{\footnotesize
...
\begin{table}[htb]
\centering
\caption[Lattices vibration of \ce{MS2}]{Lattices vibration of \ce{MS2}, reproduced from Ref.\cite{Molina-Sanchez2011}}\label{tab:tmslattice}
\begin{tabular}{lcccc}
\toprule
...
\caption[\ce{MS2} vibration symmetry]{\ce{MS2} vibration symmetry in bulk and monolayer, adopted from Ref.\cite{Ghorbani-asl}}
\label{fig:ws2ramsch}
\end{figure}
