...
\begin{figure}[htb]
\centering
\includegraphics[width=8in]{CVD_model.jpg}
...
\begin{figure}[htb]
\centering
\subfloat[\fbox{P-1}]{\label{fig:gauge}\includegraphics[width=0.4\textwidth]{pressure_gauge}}\hspace{0.04\textwidth}
\subfloat[]{\label{fig:switch}\includegraphics[width=0.4\textwidth]{toggle_switch}}
...
\item 20-22 mTorr reading for the pressure gauge (\fbox{P-1})of oxide CVD, as shown in Fig.~\ref{fig:gauge};
\item 45-50 mTorr reading for the pressure gauge (\fbox{P-1}) of sulfur CVD. 
\end{itemize} 
and the mass flow controller reading (\fbox{MFC}) should be either negative or zero.
...
\begin{itemize}
\item 760 Torr reading for the pressure gauge (\fbox{P-1}) of ZnTe CVD;
\item 32-33 Torr reading for the pressure gauge (\fbox{P-1})of oxide CVD;
\item 24 Torr reading for the pressure gauge (\fbox{P-1}) of sulfur CVD.  
\end{itemize} 
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.4\textwidth]{toggle_switch.jpg}
...
\begin{enumerate}
\item close \fbox{V-5}, you should observe \fbox{P-1} reading increases;
\item toggle Ar gas switch from OFF to ON, wait for 10 s to see the corresponding \fbox{MFC} display setting flow rate;
\item toggle Ar gas purge switch, watching pressure gauge \fbox{P-1} closely; 
...
\subsection{Using Mass Flow Controller}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.3\textwidth]{transformer}
\includegraphics[width=0.3\textwidth]{omega_temp}

\includegraphics[width=0.3\textwidth]{temp_cont2}
\includegraphics[width=0.3\textwidth]{temp_cont3}
...
The substrate used here can be either Si or 1$\mu$m \ce{SiO2}-Si. The treatment method in the seeded growth only includes usual cleaning using organic solvents. The growth steps are as following:  
...
\item Close the butterfly valve to pressure gauge (\fbox{V-6} in Fig.~\ref{fig:ch2cvd});
\item Put up the warning sign beside the furnace;
\end{enumerate}

\subsection{NaOH-Si Growth}

The substrate used here can be either Si or 1$\mu$m \ce{SiO2}-Si. The treatment in this growth includes \begin{enumerate*}[label=\itshape\alph*\upshape)]
...
The substrate used here can be either Si or 1$\mu$m \ce{SiO2}-Si. The substrate treatment in this growth includes \begin{enumerate*}[label=\itshape\alph*\upshape)]
\item usual cleaning using organic solvents;
\item plasma cleaning (2 Torr oxygen, 3 min); and
\item drop casting of NaOH solution (50 $\mu$L, 0.01 mol/L).
