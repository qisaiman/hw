...
\cite{Habib2010} oxygen plasma treatment on HF-etched Si (001). reaction among $e$, \ce{O^+}, \ce{O2^+}, \ce{O^-},\ce{O2}. \ce{OH}-terminated surface obtained.
...
\[
\cee{2LMB + O2 \rightarrow 2MB + 2H2O}
\]
