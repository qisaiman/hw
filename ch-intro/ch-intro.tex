...
Prototype \gls{ecd} usually consists of a stacked configuration as shown in Fig.~\ref{fig:introecd}. Typical transmission spectra of prototype \gls{ecd} based on \ce{WO3} thin film are shown in Fig.~\ref{fig:introtran}\cite{Lampert1998}, where $T$ in bleaching and coloration states exhibit dynamic changes. The reflectance spectra of \ce{WO3} \gls{ecd} strongly depends on the device design.\cite{OBrien1999} As to the absorption, it was deduced that the infrared part was absorbed to a large extent, which was radiated again. Assuming the emission property of \gls{ecd} being that of blackbody, Fig.~\ref{fig:introbb} displays the wavelength distribution of spectral radiance, where the spectra span from 3 $\mu$m up to 30 $\mu$m, with peaks around $8\sim10$ $\mu$m. Further thermal engineering is needed to better regulate the infrared radiation. 

\begin{figure}[htb]
\centering
\includegraphics[width=0.5\textwidth]{blackbody1}
...
\item high yield growth method of \ce{WO3} and integration with other manufacturing process; and 
