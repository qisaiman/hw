...
\caption[SEM and EDX on \ce{Na_xWO3}]{SEM images of (a) dense array of as-synthesized ultra-long nanowires on \ce{SiO2}-Si substrate and (b) rectangular microplates grow among the nanowires. (c) EDS and (d) XRD spectra showing the chemical compositions and phases of the deposition.}
...
\caption{XRD spectra of the as-synthesized specimen with the increase of growth number from 1 to 5.}
\label{fig:nawoxxrd}
\end{figure}
...
\begin{table}
\centering
\caption{XRD assignments of specimens in \ce{Na_xWO3} growth}\label{tbl:wo3xrd}
